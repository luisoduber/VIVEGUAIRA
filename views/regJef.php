...
if ($_SESSION["modRegJef"]==true) {$_SESSION["ultUrl"]=$_SERVER['REQUEST_URI'];}
else if ($_SESSION["modRegJef"]==false) { header('location:'.$_SESSION["ultUrl"]);  }
?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="container-fluid">
		<div class="row heading-bg">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			    ...
			    <?php require 'compartido/Ruta/Rt-jef.html'; ?>
		</div>
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title fw-bold">Registrar / Modificar Jefes </h5>
                                            </div>
                                            <div class="modal-body">
												<form action="" id="basic-form" method="post">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4 hidden">
                                                        <input type="hidden" id="txtIdJef" name="txtIdJef" class="form-control">
                                                    </div>
                                ...
                                <?php
                                    if ($_SESSION["idPerf"]==1)
                                    {
                                        echo '
                                        <div class="form-group col-lg-2 col-md-6 col-xs-12">
                                    <a  href="../excel/exJefTod.php" target="_blank"><button id="btnReg" class="btn btn-success">REPORTE TODOS</button></a>
                                        </div>';
                                    }
                                ?>
            ...
            <div class="row"><?php require 'compartido/DataTables/Dt-regJef.html'; ?></div>
...
<script src="../js/regJef.js"></script>
