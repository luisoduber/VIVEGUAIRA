...
if ($_SESSION["modDashInd"]==true) {$_SESSION["ultUrl"]=$_SERVER['REQUEST_URI'];}
else if ($_SESSION["modDashInd"]==false) { header('location:'.$_SESSION["ultUrl"]);  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    <a href="dashInst.php" Target="_blank" class="nav-link "><span class="pcoded-micon">
                            <i class="feather icon-layout"></i></span><span class="pcoded-mtext">Gobernación</span>
                        </a>
					</li>
                    <li class="nav-item pcoded-menu-caption">
						<label>FORMULA</label>
                    ...
                    <li class="nav-item pcoded-hasmenu">
					    <a href="dash1x10.php" Target="_blank" class="nav-link "><span class="pcoded-micon">
                            <i class="feather icon-layout"></i></span><span class="pcoded-mtext">1 x 10</span>
                        </a>
					</li>
				</ul>
			</div>
                            ...
                            <div class="card-body bg-patern">
                                ...
                                <span ><strong id="nombEst"></strong></span>
                                    ...
                                    <div class="col text-right">
                                        <h2 id="cantPartEst" class="mb-0"></h2>
