...
if ($_SESSION["modDashInst"]==true) {$_SESSION["ultUrl"]=$_SERVER['REQUEST_URI'];}
else if ($_SESSION["modDashInst"]==false) { header('location:'.$_SESSION["ultUrl"]);  }
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="pcoded-main-container pt-5">
    ...
    <script src="js/dashInst.js"></script>
