...
if ($_SESSION["modDashCentVot"]==true) {$_SESSION["ultUrl"]=$_SERVER['REQUEST_URI'];}
else if ($_SESSION["modDashCentVot"]==false) { header('location:'.$_SESSION["ultUrl"]);  }
...
<head>
    <title>DASHBOARD CENTROS VOTACIÓN</title>
    <meta charset="utf-8">
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="index.php" class="nav-link "><span class="pcoded-micon">
                            <i class="feather icon-home"></i></span><span class="pcoded-mtext">General</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					    <a href="dashInst.php" class="nav-link" Target="_blank"><span class="pcoded-micon">
...
<div class="pcoded-main-container pt-5">
    <div class="pcoded-content">
        ...
        <div class="panel-body">
            <h4><label id="nomb_evento" class="fw-bold nombEvII"></label>    
                <input type="hidden" id="txtIdParr" name="name" value="<?=$prmIdParr;?>">
                <input type="hidden" id="txtNombParr" name="name" value="<?=$prmNombParr?>">
            </h4>
        </div>
                            ...
                            <div class="card-body bg-patern">
                                ...
                                <span><strong id="nombEst"></strong></span>
                                    ...
                                    <div class="col text-right">
                                        ...
                                        <span id="porcPartEst" class="text-c-green"><i class="feather icon-trending-up ml-1"></i></span>
                                    </div>
                                </div>
        ...
        <div class="row" >
            <div class="col-md-12 col-xl-12">
                        <div class="card bg-c-red order-card">
                            <div class="card-body">
                                <h2 class="text-center text-white"><span id="titParr"></span></h2>
                            </div>
                        </div>
                    </div>
            <div class="panel-body">
    ...
    <script src="js/dashCentVot.js"></script>
