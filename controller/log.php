<?php 
require_once "../Models/ClsLog.php";
require_once "../Controllers/clsGen.php";
			...
			elseif ($rsDatLog['idUsu']!="") 
			{
				...
				if (password_verify($prmClav,$claveBd))
				{
					...
					if ($idStat==1) 
					{
						...
						$_SESSION["codCentVot"]=$rsDatLog['codCentVot'];
						$_SESSION["nombPerf"]=$rsDatLog['nombPerf'];
						$_SESSION["idEst"]=$rsDatLog['idEst'];
						$_SESSION["idMun"]=$rsDatLog['idMun'];
						$_SESSION["idParr"]=$rsDatLog['idParr'];
