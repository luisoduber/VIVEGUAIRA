...
$rsDatParr=$clsSeg->procPartInstTod(1,$_SESSION['idEvent']);
  ...
  $cardUni.='
            <div class="col-md-6 col-xl-3 ">
                <div class="card card-body bg-c-blue order-card h-75">
                            ...
                            '.$prmNombUni.'<br>'.number_format($prmPorcRest,1, '.', ' ').'%
                            </span></h5>
                </div>
            </div>
          ...
          $ListParr.='  <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body bg-patern">
                                <div class="row">
                                    <div class="col-auto">
                                <span><strong>'.$prmNombInst.'</strong></span>
                                    </div>
...
$prmPorcPartInst,$prmPorcRestInst,$cardUni);
